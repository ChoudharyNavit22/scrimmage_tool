...
#include <new-scrimmage-plugin/plugins/controller/MyCarController/MyCarController.h>
...
REGISTER_PLUGIN(scrimmage::Controller,
                scrimmage::controller::MyCarController,
                MyCarController_plugin)

namespace scrimmage {
namespace controller {

void MyCarController::init(std::map<std::string, std::string> &params) {
...
bool MyCarController::step(double t, double dt) {
