...
#include <new-scrimmage-plugin/plugins/autonomy/TravelToTarget/TravelToTarget.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::TravelToTarget,
                TravelToTarget_plugin)

namespace scrimmage {
namespace autonomy {

void TravelToTarget::init(std::map<std::string, std::string> &params) {
...
void TravelToTarget::publish_waypoint(double t) {
