...
#ifndef INCLUDE_NEW_SCRIMMAGE_PLUGIN_PLUGINS_SENSOR_MYRAYTRACE_MYRAYTRACE_H_
#define INCLUDE_NEW_SCRIMMAGE_PLUGIN_PLUGINS_SENSOR_MYRAYTRACE_MYRAYTRACE_H_
...
namespace scrimmage {
namespace sensor {
class MyRayTrace : public scrimmage::Sensor {
 public:
    class PCPoint {
     public:
...
#endif // INCLUDE_NEW_SCRIMMAGE_PLUGIN_PLUGINS_SENSOR_MYRAYTRACE_MYRAYTRACE_H_
